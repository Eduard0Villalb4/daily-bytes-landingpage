        ...
        <div className="grid grid-cols-12 gap-8 text-slate-500 py-16">
          <div className="col-span-4 xl:col-span-4">
            ...
            <div className='flex space-x-16'>
              <ul>
                <li className="py-3">
                  <a href="./ta-terms-and-conditions">TA - Terms and Conditions</a>
                </li>
                <li className="py-3">
                  <a href="./bta-terms-and-conditions">BTA - Terms and Conditions</a>
                </li>
                <li className="py-3">
                  <a href="./ta-privacy-policy">TA - Privacy Policy</a>
                </li>
                <li className="py-3">
                  <a href="./bta-privacy-policy">BTA - Privacy Policy</a>
                </li>
              </ul>
              <ul>
                <li className="py-3">
...
export default BTATermsAndCondition;